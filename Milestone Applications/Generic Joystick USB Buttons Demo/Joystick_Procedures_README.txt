...
#########################################################################################
	...
	Files needed:
		...
		File name: joystick_buttons_demo.ino
		...
		File name: ./CLASS_JOYSTICK1/Debug/CLASS_JOYSTICK1.hex
	...
	Procedure:
		...
		(File name: File name: ./CLASS_JOYSTICK1/Debug/CLASS_JOYSTICK1.hex)

		Command: avrdude -p atmega16u2 -F -P usb -c avrispmkii -U flash:w:CLASS_JOYSTICK1.hex -U lfuse:w:0xFF:m -U hfuse:w:0xD9:m -U efuse:w:0xF4:m -U lock:w:0x0F:m
